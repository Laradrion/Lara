...
class CFormElement implements ArrayAccess {
    ...
    public function __construct($name, $attributes = array()) {
        ...
        if (is_callable('CLara::Instance()')) {
            $this->characterEncoding = CLara::Instance()->config['character_encoding'];
        } else {
    ...
    public static function Create($name, $attributes) {
        $types = array(
            ...
            'linebreak' => 'CFormElementLinebreak',
        );
    ...
    public function Validate($rules, $form) {
        ...
        $tests = array(
            ...
            'email_adress' => array('message' => 'Must be an email adress.', 'test' => function($value) {
...
class CFormElementLinebreak extends CFormElement {
...
class CForm implements ArrayAccess {
    ...
    public function Value($element) {
        ...
        } else if(isset($this[$element]['values'])) {
    ...
    /**
     * Get checked values of a form element
     *
     * @param $element string the name of the formelement.
     * @return mixed the value of the element.
     */

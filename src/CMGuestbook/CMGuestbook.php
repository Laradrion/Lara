...
class CMGuestbook extends CObject implements IHasSQL, IModule {
    ...
    public static function SQL($key = null) {
        $queries = array(
            'create table guestbook' => "CREATE TABLE IF NOT EXISTS Lara_Guestbook (id INTEGER PRIMARY KEY, entry TEXT, created DATETIME default (datetime('now')));",
            'insert into guestbook' => 'INSERT INTO Lara_Guestbook (entry) VALUES (?);',
            'select * from guestbook' => 'SELECT * FROM Lara_Guestbook ORDER BY id DESC;',
            'delete from guestbook' => 'DELETE FROM Lara_Guestbook;',
        );
